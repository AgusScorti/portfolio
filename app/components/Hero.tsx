  ...
  return (
    <section id="hero" className="hero-section">
      ...
      <h1 style={{
        ...
        <br />
        <span style={{ fontWeight: 900, color: "var(--text-primary)" }}>Agus</span>
